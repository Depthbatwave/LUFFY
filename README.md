...
- **API Integration**: Gemini API implementation needs completion (OpenAI API completed)
...
- **Data Processing**: Batch dimension edge cases (folding/unfolding completed)
...
- [ ] **luffy/verl/verl/protocol.py:114** - Handle edge cases where batch_size is not divisible by new_batch_size
